...
create table Habits (
    ...
    skip_days_list integer not null default 0,
...
insert into Habits (id, archived, color, description, freq_den, freq_num, highlight, name, position, reminder_min, reminder_days, type, target_type, target_value, unit, question, uuid, skip_days, skip_days_list)
select id, archived, color, description, freq_den, freq_num, highlight, name, position, reminder_min, reminder_days, type, target_type, target_value, unit, question, uuid, skip_days, skip_days_list
from Habits_old;
